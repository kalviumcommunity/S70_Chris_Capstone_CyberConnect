import React, {
    ...
    useMemo,
    useState,
    useContext, // Added for clarity, though React itself is already imported
    createContext, // Added for clarity
    forwardRef // Added for clarity
  } from "react";
  import { Slot } from "@radix-ui/react-slot";
  import { cva } from "class-variance-authority";
  import { PanelLeft } from "lucide-react";
  
  import { useIsMobile } from "@/hooks/use-mobile"; // Assuming these paths are correct for your project
  import { cn } from "@/lib/utils"; // Assuming these paths are correct for your project
  ...
  import { Separator } from "@/components/ui/separator"; // Assuming these paths are correct for your project
  import { Sheet, SheetContent } from "@/components/ui/sheet"; // Assuming these paths are correct for your project
  import { Skeleton } from "@/components/ui/skeleton"; // Assuming these paths are correct for your project
  import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
    TooltipTrigger,
  } from "@/components/ui/tooltip"; // Assuming these paths are correct for your project
  ...
  const SidebarMenuButton = forwardRef(
    (
      ...
      if (typeof tooltip === "string") {
          ...
          tooltipProps = { ...tooltip }; // Assume tooltip is an object with props
      }
      ...
      return (
        <Tooltip>
          ...
          <TooltipContent
            ...
            {...tooltipProps} // Spread the resolved tooltip props
          />
        </Tooltip>
      );
    }
  ...
  const SidebarMenuSubButton = forwardRef(
    ({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
      const Comp = asChild ? Slot : "a"; // Assuming 'a' is the default if not a link
